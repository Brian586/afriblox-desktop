...
const displayPermissionDeniedWarning = (browserWindow, permissionType) => {
    ...
    case 'camera':
        ...
        message = 'Permission to use the camera has been denied. ' +
            'Afriblox will not be able to take a photo or use video sensing blocks.';
        break;
    case 'microphone':
        title = 'Microphone Permission Denied';
        message = 'Permission to use the microphone has been denied. ' +
            'Afriblox will not be able to record sounds or detect loudness.';
        break;
    ...
    case 'darwin':
        instructions = 'To change Afriblox permissions, please check "Security & Privacy" in System Preferences.';
        break;
    default:
        instructions = 'To change Afriblox permissions, please check your system settings and restart Afriblox.';
        break;
    }
    message = `${message}\n\n${instructions}`;
