...
const PrivacyElement = () => (
    <div className={styles.privacyBox}>
        ...
        <i>The Afriblox Privacy Policy was last updated: October 5, 2020</i>
        <p>
            The Afriblox Foundation (&ldquo;Afriblox&rdquo;, &ldquo;we&rdquo; or &ldquo;us&rdquo;) understands how
            ...
            >Afriblox App</a>&rdquo;), how we use, process, and share it, and what we&apos;re doing to keep it safe. It
        ...
        <h2>What Information Does Afriblox Collect About Me?</h2>
        <p>
            For the purpose of this Privacy Policy, &ldquo;Information&rdquo; means any information relating to an
            identified or identifiable individual. The Afriblox App automatically collects and stores locally the
            following Information through its telemetry system: the title of your project in text form, language
            setting, time zone and events related to your use of the Afriblox App (namely when the Afriblox App was
            opened and closed, if a project file has been loaded or saved, or if a new project is created). If you
            choose to turn on the telemetry sharing feature, the Afriblox App will transmit this information to Afriblox.
            Projects created in the Afriblox App are not transmitted to or accessible by Afriblox.
        </p>
        <h2>How Does Afriblox Use My Information?</h2>
        <p>We use this Information for the following purposes:</p>
        <ul>
            <li>
                <b>Analytics and Improving the Afriblox App</b> - We use the Information to analyze use of the Afriblox
                App and to enhance your learning experience on the Afriblox App.
            </li>
            <li>
                ...
                people learn through the Afriblox App and how we can enhance learning tools for young people. The
            ...
            <li>
                ...
                policies. We may do this by analyzing your use of the Afriblox App.
            </li>
        </ul>
        ...
        <p>
            ...
            (if you choose to allow the Afriblox App to send the Afriblox team your Information) to create, analyze and
            share your aggregated or de-identified Information for research purposes, to analyze and enhance your
            learning experience on the Afriblox App and otherwise ensure and improve the safety, security, and
            performance of the Afriblox App. We only rely on our or a third party’s legitimate interests to process your
            Information when these interests are not overridden by your rights and interests.
        </p>
        <h2>How Does Afriblox Share My Information?</h2>
        <p>
            We disclose information that we collect through the Afriblox App to third parties in the following
            circumstances:
        </p>
        <ul>
            <li>
            ...
            <li>
                ...
                of Technology (MIT), to learn about how our users learn through the Afriblox App and develop new
        ...
        <p>
            The Afriblox Foundation is a 501(c)(3) nonprofit organization. As such, the Children&apos;s Online Privacy
            Protection Act (COPPA) does not apply to Afriblox. Nevertheless, Afriblox takes children&apos;s privacy
            seriously. Afriblox collects only minimal information from its users, and only uses and discloses
            information to provide the services and for limited other purposes, such as research, as described in this
            Privacy Policy.
        </p>
        <p>
            Afriblox does not collect information from a student&apos;s education record, as defined by the Family
            Educational Rights and Privacy Act (FERPA). Afriblox does not disclose information of students to any third
        ...
        <ul>
            ...
            <li>
                ...
                provided in a contract between Afriblox and you, or (iii) if we have a compelling reason to do so (such
        ...
        <h2>How Does Afriblox Protect My Information?</h2>
        <p>
            Afriblox has in place administrative, physical, and technical procedures that are intended to protect the
            Information we collect on the Afriblox App against accidental or unlawful destruction, accidental loss,
        ...
        <p>
            ...
            the U.S. (where our Afriblox servers are located) or any other country in which we or our service providers
        ...
        <p>
            ...
            revised. Your continued use of the Afriblox App following these changes means that you accept the revised
            Privacy Policy.
        </p>
        <h2>Contact Us</h2>
        <p>
            The Afriblox Foundation is the entity responsible for the processing of your Information. If you have any
        ...
        <div className="vcard">
            <div className="org">Afriblox</div>
